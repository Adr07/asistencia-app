...
/**
 * Paso después de hacer check-out.
 * Muestra la hora de salida, el tiempo trabajado y botones para reiniciar o cerrar sesión.
 */
export function CheckedOutStep({
  ...
  return (
    <View>
      {/* Mensaje de salida registrada y tiempo trabajado */}
      ...
      {/* Botones para reiniciar o cerrar sesión */}
      {onLogout ? (
